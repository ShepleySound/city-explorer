...
class App extends React.Component {
  ...
  handleSearch = async (e) => {
    ...
    try {
      ...
      const weatherResponse = await axios.get(`shepleysound-city-explorer-api.herokuapp.com/weather?search_query=${this.state.searchQuery}&lat=${locationResponse.data[0].lat}&lon=${locationResponse.data[0].lon}`);
      this.setState({
